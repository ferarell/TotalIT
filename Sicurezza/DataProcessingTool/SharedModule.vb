...
Module SharedModule
    ...
    Friend Sub ExportarExcel(sender As System.Object, filename As String)
        Dim oGridView As New GridView
        oGridView = sender.MainView
        Dim sPath As String = Path.GetTempPath
        Dim sFileName = IIf(filename = Nothing, (FileIO.FileSystem.GetTempFileName).Replace(".tmp", ".xls"), filename)
