...
Public Class LibroCajaBancos1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuipuReports.LibroCajaBancos1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLibroCajaBancos1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LibroCajaBancos1 = New LibroCajaBancos1()
        rpt.Site = Me.Site
        Return rpt
    End Function
