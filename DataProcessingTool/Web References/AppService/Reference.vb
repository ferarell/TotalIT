...
Namespace AppService
    ...
    Partial Public Class OdooService
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/ExecuteSQL", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function ExecuteSQL(ByVal SqlText As String) As System.Data.DataSet
            Dim results() As Object = Me.Invoke("ExecuteSQL", New Object() {SqlText})
            Return CType(results(0),System.Data.DataSet)
        End Function
        
        '''<remarks/>
        Public Overloads Sub ExecuteSQLAsync(ByVal SqlText As String)
            Me.ExecuteSQLAsync(SqlText, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub ExecuteSQLAsync(ByVal SqlText As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ExecuteSQL", New Object() {SqlText}, Me.ExecuteSQLOperationCompleted, userState)
        End Sub
