...
Module SharedModule
    ...
    '    Dim oAccessDB As String = MDBFileName
    '    'If DBFile = "" Then
    ...
    Friend Function GetInvalidMessageBody(sender As String) As String
        ...
        Msg.AppendText(GetHtmlText(Filter, "Body", 1))
        'Signature
        Msg.AppendText(GetHtmlText(Filter, "Signature", 1))
    ...
    Friend Function GetValidMessageBody(sender As String) As String
        ...
        Msg.AppendText(GetHtmlText(Filter, "Header", sResponseType))
        If sResponseType = 3 Then
            GetHtmlTable(sender, dtQuery)
        End If
        If sResponseType = 3 Then
            If bIssued Then
                Msg.AppendText(GetHtmlText(Filter, "Body", sResponseType))
            Else
                Msg.AppendText(GetHtmlText(Filter, "Body", 1))
            End If
        Else
        ...
        If ActiveNotice() Then
            Msg.AppendText(GetHtmlText(Filter, "News", sResponseType))
        End If
        'Signature
        Msg.AppendText(GetHtmlText(Filter, "Signature", sResponseType))
    ...
    Friend Function ActiveNotice() As Boolean
        ...
        If IsDBNull(dtConfig.Rows(0)("NewsValidityFrom")) Then
            Return bResult
        End If
        IniDate = dtConfig.Rows(0)("NewsValidityFrom")
        If IsDBNull(dtConfig.Rows(0)("NewsValidityTo")) Then
            EndDate = Date.Now
        Else
            EndDate = dtConfig.Rows(0)("NewsValidityTo")
        End If
